...
const probeCommand=(command,args,options={})=>strictRunner.runCommand(command,args,{...options,env:publicNpmEnvironment({home:options.cwd??source,extra:options.env}),timeoutMs:600000,maxOutputBytes:4*1024*1024});
