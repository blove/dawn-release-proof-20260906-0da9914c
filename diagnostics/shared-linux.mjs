...
await writeFile(path.join(output,'NOTICE.txt'),`Diagnostic only, not recovery evidence. ${lane}. Node ${process.version} ${process.platform}. Source 6603b42ba6844f59f2970e7288b636dbd582979e. No receipt/executor authority.\n`);
